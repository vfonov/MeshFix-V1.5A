...
Vertex *Triangulation::checkGeometry()
{
 ...
 {
  ang = t->getAngle(t->v1());
  if (ang == 0 || ang == M_PI) {JMesh::warning("checkGeometry: degenerate triangle detected.\n"); MARK_BIT(t,5); MARK_BIT(t->v1(),5); MARK_BIT(t->v2(),5); MARK_BIT(t->v3(),5); return t->v1(); }
  ang = t->getAngle(t->v2());
  if (ang == 0 || ang == M_PI) {JMesh::warning("checkGeometry: degenerate triangle detected.\n"); MARK_BIT(t,5); MARK_BIT(t->v1(),5); MARK_BIT(t->v2(),5); MARK_BIT(t->v3(),5); return t->v2();}
  ang = t->getAngle(t->v3());
  if (ang == 0 || ang == M_PI) {JMesh::warning("checkGeometry: degenerate triangle detected.\n"); MARK_BIT(t,5); MARK_BIT(t->v1(),5); MARK_BIT(t->v2(),5); MARK_BIT(t->v3(),5); return t->v3();}
 }
